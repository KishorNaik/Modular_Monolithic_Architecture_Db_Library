...
export interface IGetUsersService
	extends IServiceHandlerAsync<IGetUsersServiceParameters, IPageListResult<UserEntity>> {}

@sealed
@Service()
export class GetUsersService implements IGetUsersService {
	public async handleAsync(
		params: IGetUsersServiceParameters
	): Promise<Result<IPageListResult<UserEntity>, ResultError>> {
		try {
			//@guard
			if (!params)
